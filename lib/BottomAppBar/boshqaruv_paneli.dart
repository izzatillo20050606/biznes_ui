      ...
      body: Column(
        children: [
          ...
          Container(
            ...
            child: const Center(child: Text("+ Yangi maqsad qo'shish")),
          ),
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: const Color.fromARGB(255, 180, 224, 245),
